<?php
// HTTP
define('HTTP_SERVER', 'http://192.168.1.13/admin/');
define('HTTP_CATALOG', 'http://192.168.1.13/');

// HTTPS
define('HTTPS_SERVER', 'http://192.168.1.13/admin/');
define('HTTPS_CATALOG', 'http://192.168.1.13/');
